...
GetFullModels <- function(BernoulliInSample, MonthlyInSample, func) {
  mod.social.bernoulli <- func(default ~ unemployment + 
                                google_trend +
                                log(fb_likes+1) +
                                log(adjustedfollowercount+1) + 
                                log(adjustedfriendcount+1) +
  ...
  mod.social.monthly <- func(default ~ unemployment + 
                              google_trend +
                              log(fb_likes+1) +
                              log(adjustedfollowercount+1) + 
                              log(adjustedfriendcount+1) +
  ...
  mod.econ.bernoulli <- func(default ~ log(grossamountinthousand) + 
                              guaranteedratio + 
                              terminmonths + 
                            ...
                            family = binomial(),
                            data = BernoulliInSample)
  mod.econ.monthly <- func(default ~ log(grossamountinthousand) + 
                            guaranteedratio + 
                            terminmonths + 
                            borrowerbanksamestate + 
                            termisfullyear + 
                          ...
                          family = binomial(),
                          data = MonthlyInSample)
  mod.hybrid.bernoulli <- func(default ~ log(grossamountinthousand) + 
                                guaranteedratio + 
                                terminmonths + 
                                borrowerbanksamestate + 
                                termisfullyear + 
                              ...
                              family = binomial(),
                              data = BernoulliInSample)
  mod.hybrid.monthly <- func(default ~ log(grossamountinthousand) + 
                            guaranteedratio + 
                            terminmonths + 
                            borrowerbanksamestate + 
                            termisfullyear + 
